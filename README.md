# SwiftParallelBzip2
Parallel bzip2 decoding based on [lbzip2](https://github.com/kjn/lbzip2). 
...
## Usage
Data must be provided as an AsyncSequence<DataProtocol> and will be returned as AsyncSequence<ByteBuffer>. ByteBuffer is based on SwiftNIO.
